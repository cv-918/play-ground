...
inline void to_json(nlohmann::json& j, const ParticleEmitterSpec& s)
{
	j = nlohmann::json{
		{"id_", s.id_},
		{"particle_setting_id_", s.particle_setting_id_},
		{"emit_interval_sec_", s.emit_interval_sec_},
		{"emit_count_per_tick_", s.emit_count_per_tick_},
		{"duration_sec_", s.duration_sec_}
	};
}

inline void from_json(const nlohmann::json& j, ParticleEmitterSpec& s)
{
	j.at("id_").get_to(s.id_);
	j.at("particle_setting_id_").get_to(s.particle_setting_id_);
	j.at("emit_interval_sec_").get_to(s.emit_interval_sec_);
	j.at("emit_count_per_tick_").get_to(s.emit_count_per_tick_);
	j.at("duration_sec_").get_to(s.duration_sec_);
}
