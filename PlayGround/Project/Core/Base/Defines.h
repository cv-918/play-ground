...
#define INGAVE_FRAME_THICKNESS		10
#define INGAVE_FRAME_THICKNESS_HALF	(INGAVE_FRAME_THICKNESS / 2)

#define GAME_SCREEN_CX				WINCX - INGAVE_FRAME_THICKNESS
#define GAME_SCREEN_CY				WINCY - INGAVE_FRAME_THICKNESS
