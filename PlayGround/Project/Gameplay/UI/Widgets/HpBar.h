...
public:
	...
	void Appear(_double _duration = 3.0);
...
private:
	...
	_double appear_timer_ = 0.0; // 체력바가 나타난 후 경과한 시간. 이 값이 0이 되면 체력바가 완전히 사라진 것으로 간주.
	_bool on_disappear_ = false; // 체력바가 사라지는 중인지 여부를 나타내는 플래그. 필요에 따라 체력바가 사라지는 동안 추가적인 효과나 로직을 처리할 때 활용할 수 있습니다.
