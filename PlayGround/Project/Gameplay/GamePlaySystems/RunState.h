...
public:
	...
	void MarkAsPlayerDied();
	void MarkEndReason(RunEndReason _reason);
	...
	_bool IsKillGoalReached() const { return kill_goal_reached_; }
	_bool IsStageClearEligible() const { return stage_clear_eligible_; }
