...
function buildPrompt(input) {
  ...
  return [
    ...
    "- Keep clarifying questions only for validation work that asks for an unknown command or evidence type that is not already covered by that deterministic build route.",
    "",
