...
function renderInboxPageShell() {
  return `        <section class="page" data-page="inbox">
          <section class="card">
            ...
            <p class="muted small">승인, 수정 요청, 보류, 반려가 필요한 항목만 봅니다. 이 화면의 판단은 자동 실행, worker 시작, commit/push를 하지 않습니다.</p>
            <div id="directorInboxFull" class="list"></div>
          </section>

          <details class="card dashboard-reference-section">
            <summary class="section-title"><h2>Decisions 역할</h2><span class="pill">Director decision</span></summary>
            <ul class="small">
              <li>큰 방향, 완료 검토, 수정 요청, 채택/반려처럼 Human Director가 결정해야 하는 항목만 모읍니다.</li>
              <li>각 카드에서 “내가 결정할 것”과 “결정하면 바뀌는 것”을 먼저 보고 판단합니다.</li>
