...
function renderRunsPageShell() {
  return `        <section class="page" data-page="runs">
          <div class="card">
            <div class="section-title"><h2>References: Staff Reports</h2><span class="pill">read-only reference</span></div>
            <ul class="small">
          ...
          <section class="card">
            ...
            <div class="grid">
              <div class="item"><h2>직원 보고서</h2><p class="muted">AI 직원 실행 결과입니다. 먼저 보고서를 읽고, 쓸 만한 내용만 채택 후보로 넘깁니다.</p><div id="runs" class="list"></div></div>
              <div class="item"><h2>채택 후보 검토</h2><p class="muted">직원 보고서에서 뽑아 둔 후보를 채택, 반려, 보류, 수정 요청으로 정리합니다. 후보를 채택해도 실행 승인이나 공식 설정 확정은 별도입니다.</p><div id="materializations" class="list"></div></div>
            </div>
          </section>
