...
function renderEvidencePageShell() {
  return `        <section class="page" data-page="evidence">
          ...
          <div class="card">
            <h2>Result Review: 이 페이지에서 하는 일</h2>
            <ul class="small">
          ...
          <div class="grid">
            ...
            <div class="card span-all"><h2>버튼 실행 결과</h2><p class="muted small">위 버튼을 누르면 이곳에 읽기 전용 결과가 표시됩니다. 실행 상태, commit, push는 바꾸지 않습니다.</p><div id="evidenceResult" class="list"><div class="empty">아직 실행한 버튼 결과가 없습니다.</div></div></div>
            <div class="card span-all"><h2>Result Review 레코드</h2><p class="muted small">구현 요약, 변경 파일, 검증 결과, 위험, 사람이 결정할 항목을 먼저 보여주고 내부 evidence refs는 접어서 둡니다.</p><div id="packets" class="list"></div></div>
          </div>
        </section>
