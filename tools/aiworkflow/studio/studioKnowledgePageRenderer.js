...
function renderKnowledgePageShell() {
  return `        <section class="page" data-page="knowledge">
          ...
          <div class="grid">
            <div class="card">
              <div class="section-title"><h2>기록 작성</h2><span class="pill">외부 조사</span></div>
            ...
            <div class="card">
              <div class="section-title"><h2>참고 기록 / 공식 설정 후보 직접 저장</h2><span class="pill">프로젝트 지식</span></div>
              <p class="small muted">AI 직원이 이후 참고해야 할 프로젝트 지식을 저장합니다. 일반 기록은 참고용 메모이고, 공식 설정 후보는 게임 세계관/규칙처럼 확정 근거가 될 수 있으므로 신중하게 남깁니다.</p>
              <div class="form-grid">
          ...
          <details class="internal-panel">
            <summary>수동 제안/결정 입력</summary>
            <p class="small muted">보통은 제안 카드나 결정 카드의 버튼으로 기록을 넘깁니다. 직접 입력이 필요할 때만 이 영역을 사용하세요.</p>
            <div class="grid">
              <div class="item">
          ...
          <details class="card dashboard-reference-section">
            ...
            <div class="grid">
              <div class="item">
                <h3>검토만 할 때</h3>
                <ul class="small">
                  <li><strong>전환 계획</strong>: 제안이나 결정이 업무, 참고 기록, 공식 설정 후보 중 어디로 넘어갈 수 있는지 미리 봅니다. 기록은 만들지 않습니다.</li>
                </ul>
              </div>
              <div class="item">
                <h3>판단을 남길 때</h3>
                <ul class="small">
                  <li><strong>채택 판단 남기기</strong>: 아직 판단하지 않은 제안에만 표시됩니다. 이 제안을 방향으로 받아들인다는 판단을 남깁니다.</li>
                  <li><strong>공식 설정 후보로 남기기</strong>: 게임 설정/세계관 후보에만 표시됩니다. Studio UX 같은 운영 제안에는 사용하지 않습니다.</li>
                  <li><strong>수정 요청</strong>: 지금 형태로는 부족하니 다시 다듬어야 한다는 판단을 남깁니다.</li>
                  <li><strong>반려 판단 남기기</strong>: 채택하지 않는다는 판단을 남깁니다.</li>
                </ul>
              </div>
              <div class="item">
                <h3>이미 판단한 제안</h3>
              ...
              <div class="item">
                <h3>결정 기록을 넘길 때</h3>
                <ul class="small">
                  <li><strong>전환 계획</strong>: 참고 기록이나 공식 설정 후보로 넘길 수 있는지 미리 봅니다. 기록은 만들지 않습니다.</li>
                  <li><strong>참고 기록으로 저장</strong>: AI 직원이 이후 작업에서 참고할 일반 기록을 만듭니다.</li>
                  <li><strong>공식 설정으로 저장</strong>: 게임 설정 후보를 공식 설정 검토 기록으로 남깁니다. 공식 설정 후보일 때만 표시됩니다.</li>
                </ul>
              </div>
            </div>
          </details>
