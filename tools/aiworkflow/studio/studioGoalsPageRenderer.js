...
function renderGoalsPageShell() {
  return `        <section class="page" data-page="goals">
          <div class="card">
            <h2>이 페이지의 역할</h2>
            <ul class="small">
              <li>감독자가 새 안건을 던지고, Studio가 이를 Director Brief로 정리하는 첫 화면입니다.</li>
              <li>Studio는 안건을 AI 직원 자문, 업무 후보, 결정 후보, 승인 필요 항목으로 나눠서 보여줍니다.</li>
              <li>여기서 만드는 것은 브리프와 다음 단계 후보입니다. 공식 설정 확정, 소스 수정, task 실행, commit/push는 하지 않습니다.</li>
            </ul>
          </div>
          <section class="grid">
            <div class="card">
              <div class="section-title"><h2>새 안건 입력</h2><span class="pill">Director Brief</span></div>
              <p class="small muted">세부 업무 지시가 아니라 “무엇을 더 좋게 만들고 싶은지”를 적습니다. 구현 방법은 Studio가 자문과 다음 단계 후보로 나눕니다.</p>
              <div class="row">
              ...
              <label class="field-block">안건 <span class="required-mark">필수</span><span class="field-help">원하는 결과를 사람 말로 적습니다. 예: “초반 루프가 더 명확하게 느껴지게 만들고 싶다.”</span><textarea id="goalCreateText" placeholder="예: 초반 10분 플레이 루프를 더 명확하게 만들고, 필요한 기획/구현/검증 업무를 나눠줘."></textarea></label>
              ...
              <div class="row">
                <button class="secondary" id="goalPlanSubmit">브리프 미리보기</button>
                <button class="good" id="goalStoreSubmit">브리프만 저장</button>
                <button class="warn" id="goalBundleSubmit">브리프 + 다음 단계 후보 생성</button>
              </div>
              <ul class="small muted button-help">
                ...
                <li><strong>다음 단계 후보 생성:</strong> 자문/업무/제안 후보까지 만듭니다. 실제 구현과 커밋은 여전히 별도 승인 흐름을 탑니다.</li>
              </ul>
            </div>
            <div class="card">
          ...
          <section class="card">
            <div class="section-title"><h2>저장된 Director Brief / 안건 분해안</h2><span id="goalPlanCount" class="pill"></span></div>
