...
2. Choose `GAME-007C/007D` only if continuing data-loader cleanup before home playtest
...
readability-script false positives, and GAME-007A/GAME-007B implemented the
first data-loader path/policy + Stage loader safety slices with green data smoke
and Debug x64 build.
```
