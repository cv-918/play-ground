...
| WF-025 | P1 | todo | automation | Implement Codex/Copilot task routing prompt generation | Discord workflow should generate execution-engine prompts after safe validation commands are stable | Codex App -> manual validation | routing prompt generation validation pending |
