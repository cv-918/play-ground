...
| WF-023 | P1 | todo | automation | Implement Discord approval and status note commands | Next workflow stage should support approve/block/done/defer after task management is stable | Codex App -> manual validation | Discord approval command validation pending |
