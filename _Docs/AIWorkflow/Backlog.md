...
| WF-024 | P1 | todo | automation | Implement Discord safe script execution commands | Discord should be able to run allowlisted workflow validation scripts after status command writes are stable | Codex App -> manual validation | safe script execution validation pending |
